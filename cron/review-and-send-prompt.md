...
- If 5 section files exist (system-design, algorithms, soft-skills, frontend, ai, each >500 bytes) → normal weekday
...
If more issues found → go back to Step 2. Loop until clean.
...
- Message 4: frontend
- Poll 4b: quiz from /tmp/bbb-quiz-4.json (pollAnonymous: false), then answer reveal
- Message 5: AI
